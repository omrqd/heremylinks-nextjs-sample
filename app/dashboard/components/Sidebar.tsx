    ...
    <>
      ...
      <div className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ''}`}>
        ...
        <nav className={styles.sidebarMenu}>
          ...
          <Link href="/dashboard/insights" className={styles.sidebarMenuItem}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/dashboard/settings" className={styles.sidebarMenuItem}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/dashboard/contact" className={styles.sidebarMenuItem}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
